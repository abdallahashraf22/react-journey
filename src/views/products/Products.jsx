                        ...
                        <div key={product.id} className="col-3 text-center">
                            <Card  className="text-center justify-content-center align-content-center d-flex mx-auto my-2">
                                <div className="d-flex justify-content-center">
                                    <Card.Img variant="top" src={product.image} style={{ width:250,height:200 }}/>
                                </div>
                                <Card.Body>
                                    ...
                                    <Link to={`${product.id}`}><button className="btn btn-outline-dark">Show details</button></Link>
                                </Card.Body>
                            </Card>
                        </div>
                    )
